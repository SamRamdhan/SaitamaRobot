...
@run_async
def gombal(update: Update, context: CallbackContext):
...
def slap(update: Update, context: CallbackContext):
    ...
    curr_user = {mention_html(message.from_user.id, message.from_user.first_name)}
    ...
    if user_id:
        ...
        user1 = {mention_html(context.bot.id, context.bot.first_name)}
        user2 = curr_user
